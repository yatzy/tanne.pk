...
shops_pk$lon = sapply(shops_pk$lon , '[[' , 1)
shops_pk$lat = sapply(shops_pk$lat , '[[' , 1)
sapply(shops_pk , i)s
write_csv(data.frame(shops_pk) , '/home/yatzy/Applications/tanne.pk/Data/shops_pk_coords.csv' )
